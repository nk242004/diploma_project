# Generated by Django 4.1.2 on 2023-05-23 09:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_activated', models.BooleanField(db_index=True, default=True, verbose_name='User went through activation')),
                ('send_messages', models.BooleanField(default=True, verbose_name='Send user messages')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Show in list')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Show in list')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Published')),
                ('bb', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.bb', verbose_name='Goods')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='bb',
            name='rubric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.subrubric', verbose_name='Rubric'),
        ),
    ]
